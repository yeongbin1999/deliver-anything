...
import com.deliveranything.domain.delivery.handler.DeliveryStatusEventHandler;
import com.deliveranything.domain.delivery.handler.OrderDeliveryStatusEventHandler;
...
public class DeliveryService {
  ...
  private final DeliveryStatusEventHandler deliveryStatusEventHandler;
  private final OrderDeliveryStatusEventHandler orderDeliveryStatusEventHandler;
  ...
  public void changeStatus(Long deliveryId, DeliveryStatus next) {
    ...
    deliveryStatusEventHandler.handleDeliveryStatus(event);
  }
  ...
  public void publishRiderDecision(@Valid RiderDecisionRequestDto decisionRequestDto,
    ...
    orderDeliveryStatusEventHandler.handleOrderDeliveryStatus(event);
  }
